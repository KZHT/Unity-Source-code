...
public class Enemyscript : MonoBehaviour {
	...
	// 理由：
	// ・重い
	// 　Inspectorで直接している方がまだ良い。
	// 　あとOnEnableで毎回取得する必要あるかな？AwakeでFindeして SetActiveで消したり出したりすればよいのでは？
	// ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ichi
	...
	// ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- 
	// 範囲を書く場合は、範囲順に書くと良い
	//	 -5f <= playerx && playerx <= 5f && -5f <= playery && playery <= 5f
	// 理由：
	// ・見やすい
	// 　これは趣味・趣向のれべるなので気に入ったらレベル
	// 　あとこれは衝突判定の類だとおもうが、関数化すべき。
	// ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ichi
